...
def run_stats_calc_by_pitch(df, ferrets, stats_dict, pitch_param = 'inter_trial_roving', kw_test = True, repeated_anova = True ):
    ...
    for value in ['hits', 'false_alarms', 'correct_response']:
        ...
        res.anova_table.to_csv(f'D:\mixedeffectmodelsbehavioural/metrics/trainingdata/anova_results_bypitch_{value}.csv')
        #export eta_squared to csv
        eta_squared_df = pd.DataFrame({'partial_eta_squared': [partial_eta_squared]})
        eta_squared_df.to_csv(f'D:\mixedeffectmodelsbehavioural/metrics/trainingdata/eta_squared_bypitch_{value}.csv')
        ...
        posthoc_df.to_csv(f'D:/mixedeffectmodelsbehavioural/metrics/trainingdata/posthoc_results_{value}.csv')
    ...
    if kw_test == True:
        ...
        kw_dict_all_df.to_csv(f'D:\mixedeffectmodelsbehavioural\metrics/trainingdata/kw_dict_bypitch.csv')
...
def plot_stats(stats_dict_all_combined, stats_dict_combined):
    ...
    plt.savefig('figs/trainingdata/proportion_hits_falsealarms_correctresp_dprime_bytalker_2706.png', dpi = 500, bbox_inches='tight')
    plt.show()
    ...
    plt.savefig('figs/trainingdata/bias_bytalker_2706.png', dpi=500, bbox_inches='tight')
    plt.show()
...
def plot_stats_by_pitch(stats_dict_all_combined, stats_dict_combined, stats_dict_all_inter, stats_dict_inter, stats_dict_all_intra, stats_dict_intra):
    ...
    plt.savefig('figs/trainingdata/proportionofhitsbyF0_noaxisannotation.pdf', dpi = 500, bbox_inches='tight')
    plt.show()
    return
...
def plot_stats_by_pitch_lineplot(stats_dict_all_combined, stats_dict_combined, stats_dict_all_inter, stats_dict_inter, stats_dict_all_intra, stats_dict_intra):
    ...
    plt.savefig('figs/trainingdata/proportionofhits_FA_byF0_noaxisannotation.pdf', dpi = 500, bbox_inches='tight')
    plt.savefig('figs/trainingdata/proportionofhits_FA_byF0_noaxisannotation.png', dpi = 500, bbox_inches='tight')
    ...
    plt.savefig('figs/trainingdata/proportionofhits_dprimecorrect_response_byF0_noaxisannotation.pdf', dpi = 500, bbox_inches='tight')
    plt.savefig('figs/trainingdata/proportionofhits_dprimecorrect_response_byF0_noaxisannotation.png', dpi = 500, bbox_inches='tight')
...
def run_repeated_anova(stats_dict_inter, stats_dict_intra, stats_dict_control):
    ...
    for talker in [1,2]:
        ...
        for value in ['hits', 'false_alarms', 'correct_response', 'dprime', 'bias']:
            ...
            eta_squared_df = pd.DataFrame({'partial_eta_squared': [partial_eta_squared]})
            eta_squared_df.to_csv(f'D:\mixedeffectmodelsbehavioural\metrics/trainingdata/eta_squared_rovingtype_{value}.csv')
            #export to csv
            tukey_df = pd.DataFrame(data=posthocresults._results_table.data[1:],
                                    columns=posthocresults._results_table.data[0])

            tukey_df.to_csv(f'D:\mixedeffectmodelsbehavioural\metrics/trainingdata/posthocresults_by_rovingtype_{value}.csv')
            anovaresults.anova_table.to_csv(f'D:\mixedeffectmodelsbehavioural\metrics/trainingdata/anova_results_by_rovingtype_{value}.csv')
